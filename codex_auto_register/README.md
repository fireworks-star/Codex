...
├── README.md                            # 本文档
├── .management-html-version            # 管理面板版本记录
├── .gitignore
└── codex/
    ├── protocol_keygen.py               # Codex OAuth 注册与 token 生成脚本
    ├── config.example.json              # Codex 脚本配置模板
    ├── README.md                        # Codex 脚本文档
    └── codex_accounts_tokens/           # Token 凭据输出目录（.gitignore 已排除）
```
